...
---
title: "**SO<sub>2</sub> from Environment Agency – Abu Dhabi (EAD) stations in the UAE**"
output:
  html_document:
    fig_height: 2.5
    fig_width: 9.5
...
# Plot
interactive_plot(time_series_ALAinIslamicIns, station = "Al Ain Islamic Ins", group =   pollutant, pollu="SO2")
interactive_plot(time_series_ALAinStreet, station = "Al Ain Street", group = pollutant, pollu="SO2")
interactive_plot(time_series_AlMafraq, station = "Al Mafraq", group = pollutant, pollu="SO2")
interactive_plot(time_series_AlQua0x27a, station = "Al Qua'a", group = pollutant, pollu="SO2")
interactive_plot(time_series_AlRuwais, station = "Al Ruwais", group = pollutant, pollu="SO2")
interactive_plot(time_series_AlTawia, station = "Al Tawia", group = pollutant, pollu="SO2")
interactive_plot(time_series_BainAljesrain, station = "Bain Al Jesrain", group = pollutant, pollu="SO2")
interactive_plot(time_series_baniyasSchool, station = "Baniyas School", group = pollutant, pollu="SO2")
interactive_plot(time_series_BidaZayed, station = "Bida Zayed", group = pollutant, pollu="SO2")
interactive_plot(time_series_E11Road, station = "E11 Road", group = pollutant, pollu="SO2")
interactive_plot(time_series_GayathiSchool, station = "Gayathi School", group = pollutant, pollu="SO2")
interactive_plot(time_series_Habshan, station = "Habshan", group = pollutant, pollu="SO2")
interactive_plot(time_series_HamdanStreet, station = "Hamdan Street", group = pollutant, pollu="SO2")
interactive_plot(time_series_KhadejaPrimarySchool, station = "Khadeja Primary School", group = pollutant, pollu="SO2")
interactive_plot(time_series_KhalifaCityA, station = "Khalifa City A", group = pollutant, pollu="SO2")
interactive_plot(time_series_KhalifaHighSchool, station = "Khalifa High School", group =pollutant, pollu="SO2")
interactive_plot(time_series_LiwaOasis, station = "Liwa Oasis", group = pollutant, pollu="SO2")
interactive_plot(time_series_Mussafah, station = "Mussafah", group = pollutant, pollu="SO2")
interactive_plot(time_series_Sweihan, station = "Sweihan", group = pollutant, pollu="SO2")
interactive_plot(time_series_Zakher, station = "Zakher", group = pollutant, pollu="SO2")
