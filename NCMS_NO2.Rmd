...
---
title: "**NO<sub>2</sub> from National Center of Meteorology & Seismology (NCMS) stations in the UAE**"
output:
  html_document:
    fig_height: 2.5
    fig_width: 9.5
...
# Plot
interactive_plot(time_series_AlHamriyah, station = "Al Hamriyah", group = pollutant, pollu="NO2")
interactive_plot(time_series_Kalba, station = "Kalba", group = pollutant, pollu="NO2")
interactive_plot(time_series_Rashidyah, station = "Rashidyah", group = pollutant, pollu="NO2")
interactive_plot(time_series_ELdErLyHouse, station = "Elderly House", group = pollutant, pollu="NO2")
interactive_plot(time_series_AlJeer, station = "Al Jeer", group = pollutant, pollu="NO2")
interactive_plot(time_series_Burairat, station = "Burairat", group = pollutant, pollu="NO2")
interactive_plot(time_series_AlQasimiyah, station = "Al Qasimiyah", group = pollutant, pollu="NO2")
interactive_plot(time_series_Ghalilah, station = "Ghalilah", group = pollutant, pollu="NO2")
```
